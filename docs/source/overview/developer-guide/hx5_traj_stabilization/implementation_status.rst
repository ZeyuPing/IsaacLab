...
trajectory-stabilization project:

* dedicated project documentation inside the existing Isaac Lab Sphinx tree
* repository-root ``Makefile`` for convenient doc builds
