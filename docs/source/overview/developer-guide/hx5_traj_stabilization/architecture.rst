...
The task package introduced in this implementation is:
...
The initial curriculum is intentionally narrow and matches the decisions already made:

* disturbance magnitude ramp
* gravity ramp from near-zero to nominal magnitude
