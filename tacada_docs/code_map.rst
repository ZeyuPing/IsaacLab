...
* ``tacada_docs/index.rst``
* ``tacada_docs/design_goals.rst``
* ``tacada_docs/architecture.rst``
* ``tacada_docs/implementation_status.rst``
* ``tacada_docs/code_map.rst``


Upstream Integrated Notes
-------------------------
...
* ``Makefile``
  Root-level TacAda-only docs and check entrypoints for local development.
